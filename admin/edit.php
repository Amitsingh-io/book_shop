...
<div class="row" style="margin-top: 25px;">
          ...
          <div class="col-lg-4 col-md-4 col-sm-3 col-12"> <input type="text" class="plang isize" name="plang" required placeholder="Language"></div>
        </div>
        <div class="row" style="margin-top: 25px;">
            <div class="col-lg-2 col-md-2 col-sm-3 col-12 ">Publication</div>
        <div class="col-lg-4 col-md-4 col-sm-3 col-12"> <input type="text" class="ppub isize" name="ppub" required placeholder="Publication"></div>
        <div class="col-lg-2 col-md-2 col-sm-3 col-12 col-sp-sm">Author Name</div>
        <div class="col-lg-4 col-md-4 col-sm-3 col-12 "> <input type="text" class="pauthor isize" name="pauthor" required placeholder="Author Name"></div>
        </div>

        <div class="row" style="margin-top: 25px;">
          <div class="col-lg-2 col-md-2 col-sm-3 col-12 ">ISBN</div>
          <div class="col-lg-4 col-md-4 col-sm-3 col-12"> <input type="text" class="pisbn isize" name="pisbn" required placeholder="ISBN"></div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-3 col-12 "> <input type="text" class="pyear isize" name="pyear" required placeholder="Year"></div>
        
            <div class="col-lg-2 col-md-2 col-sm-3 col-12 ">Month</div>
        <div class="col-lg-4 col-md-4 col-sm-3 col-12"> <input type="text" class="pmonth isize" name="pmonth" required placeholder="Month"></div>
        </div>

        
        <div class="row" style="margin-top: 25px;">
        <div class="col-lg-2 col-md-2 col-sm-3 col-12 col-sp-sm">Binding Type</div>
        <div class="col-lg-4 col-md-4 col-sm-3 col-12 "> <input type="text" class="pbind isize" name="pbind" required placeholder="Binding Type"></div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-3 col-12"> <input type="text" readonly class="cstock isize" name="cstock" required placeholder=" Current Stock" value="0" style="cursor: not-allowed;"></div>
        </div>
        <div class="row" style="margin-top: 25px;">
