...
<div class="container"><!--container 1-->
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="home-tab" data-toggle="tab" href="#" role="tab" aria-controls="home" aria-selected="true">Add New</a>
        </li>
        <li class="nav-item">
    ...
    <div class="container">
      <h3>New Product</h3>
               ...
               <form id="fupForm" action="" method="post"  enctype="multipart/form-data" >
                ...
                <div class="col-lg-4 col-md-3 col-sm-3 col-12"> <input type="text" class="pcode isize" name="pcode"  placeholder="Product code" readonly style="cursor: not-allowed;"></div>
                <div class="col-lg-2 col-md-3 col-sm-3 col-12 col-sp-sm">Product Name</div>
                <div class="col-lg-4 col-md-3 col-sm-3 col-12"> <input type="text" class="pname isize" name="pname" required placeholder="Product Name"></div>
                </div>

                <div class="row" style="margin-top: 25px;">
                    <div class="col-lg-2 col-md-3 col-sm-3 col-12 ">Publication</div>
                <div class="col-lg-4 col-md-3 col-sm-3 col-12"> <input type="text" class="ppub isize" name="ppub"  placeholder="Publication"></div>
                <div class="col-lg-2 col-md-3 col-sm-3 col-12 col-sp-sm">Author Name</div>
                <div class="col-lg-4 col-md-3 col-sm-3 col-12 "> <input type="text" class="pauthor isize" name="pauthor"  placeholder="Author Name"></div>
                </div>
                ...
                <div class="col-lg-4 col-md-3 col-sm-3 col-12"> <input type="text" class="pisbn isize" name="pisbn" placeholder="ISBN"></div>
                <div class="col-lg-2 col-md-3 col-sm-3 col-12 col-sp-sm">Year</div>
                <div class="col-lg-4 col-md-3 col-sm-3 col-12 "> <input type="text" class="pyear isize" name="pyear"  placeholder="Year"></div>
                </div>

                
                <div class="row" style="margin-top: 25px;">
                    <div class="col-lg-2 col-md-3 col-sm-3 col-12 ">Month</div>
                <div class="col-lg-4 col-md-3 col-sm-3 col-12"> <input type="text" class="pmonth isize" name="pmonth" placeholder="Month"></div>
                <div class="col-lg-2 col-md-3 col-sm-3 col-12 col-sp-sm">Binding Type</div>
                <div class="col-lg-4 col-md-3 col-sm-3 col-12 "> <input type="text" class="pbind isize" name="pbind"  placeholder="Binding Type"></div>
                </div>
                ...
                <div class="col-lg-4 col-md-3 col-sm-3 col-12 "> <select type="text" class="pcate isize" name="pcate" required placeholder="Category Type">
                ...
                <div class="col-lg-4 col-md-3 col-sm-3 col-12"> <input type="text" class="istock isize" name="istock" required placeholder="Stock"></div>     
               </div>
