...
<?php
  ...
  <div class="container"><!--container 1-->
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" id="contact-tab" data-toggle="tab" href="#" role="tab" aria-controls="contact" aria-selected="false">New Stock</a>
        </li>
        <li class="nav-item">
   ...
   <div class="col-lg-4 col-md-3 col-sm-3 col-12"> <input type="number"  class="istock isize" name="istock" required value="0"></div>
   </div>
   <div class="row" style="margin-top:25px;">
  ...
  <div class="row">
    <div class="col-lg-10 col-md-10 col-sm-10 col-12">
      <button style="left:50%; position: absolute;"id="updatestockin" class="updatestockin" >
        &nbsp;&nbsp;Update Stock &nbsp;&nbsp;
      </button>
    </div>
  </div>
 ...
 $(".pname").change(function(e)
  {
    ...
    if(index==0)
    {
      ...
      $.ajax({
        ...
        <script>
$("#updatestockin").click(function(e)
{
  e.preventDefault();
  var pcode=$(".pcode").val();
  var pname=$(".pname").val();
  ...
  if(parseInt(istock)<1)
  {
    ...
    $.ajax({
      ...
      url:'stockinphp.php',
      data:{
          pcode:pcode,pname:pname,lang:lang,istock:istock,nstock:nstock,val:'3'
      },
      success:function(data)
      {
        //alert(data);
